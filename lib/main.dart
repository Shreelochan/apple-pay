...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    StripePayment.setOptions(
      StripeOptions(publishableKey: 'pk_test_51IJbpbL7b1ztTOvPVxU0wpWaMWhYlJCbBZ0ywPs2oimywgXv7E7pM6TkkfQoH4DJFTirRjAnjVr29bKcUWGKlzgX00CP9sZlE5',
        androidPayMode: 'test',),);
  }
  ...
  Future<void> createPaymentMethod() async {
    ...
    paymentMethod != null ? processPaymentAsDirectCharge(paymentMethod)
        : showDialog(
        context: context,
...
class ShowDialogToDismiss extends StatelessWidget {
  ...
  ShowDialogToDismiss({this.title, this.buttonText, this.content});  @override
  Widget build(BuildContext context) {
    if (!Platform.isIOS) {
      return AlertDialog(
        title: new Text(
