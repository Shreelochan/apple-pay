  ...
  Future<void> makePayment() async {
    ...
    try {
      platformVersion = await FlutterApplePay.makePayment(
          ...
          merchantIdentifier: "merchant.tech.wblue.wlive",
          paymentItems: [paymentItems],
          stripePublishedKey: "pk_test_51IJbpbL7b1ztTOvPVxU0wpWaMWhYlJCbBZ0ywPs2oimywgXv7E7pM6TkkfQoH4DJFTirRjAnjVr29bKcUWGKlzgX00CP9sZlE5"
      );
